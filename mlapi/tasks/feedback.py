"""
Task functions for LLM-based interview feedback analysis.

Includes STAR feedback, competency feedback (confidence, clarity, and engagement),
and a combined overall feedback task that saves results to Firestore.
"""
...
async def analyze_interview_feedback(user_id: str, interview_id: str) -> Feedback:
    ...
    # Run STAR and competency analyses
    ...
    # Map LLM results to the Feedback/OverallCompetency schema used in the interview document
    ...
    # Build a combined overall feedback string from both analyses
    ai_feedback = (
    ...
    # Persist feedback to the interview document and mark interview as fully analyzed
